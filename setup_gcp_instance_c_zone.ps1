# GCPインスタンス構築スクリプト (ゾーンC 突撃版)
$PROJECT_ID = "nazokakeapp-137e5"
$INSTANCE_NAME = "nazokake-l4-vm"
$ZONE = "us-central1-c"

Write-Host "==========================================================" -ForegroundColor Cyan
Write-Host " 🚀 ターゲット変更: us-central1-c (Cゾーン) へ突撃します" -ForegroundColor Yellow
Write-Host "==========================================================" -ForegroundColor Cyan
...
for ($i=0; $i -lt 15; $i++) {
    ...
    if ($status -eq "RUNNING") {
        ...
        Write-Host "🚨 構築が強制停止されました。Cゾーンも在庫切れ (STOCKOUT) の可能性が高いです。" -ForegroundColor Red
        break
