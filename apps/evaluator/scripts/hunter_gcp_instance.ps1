...
# instructions/272: Tombstoned (legacy, unreferenced multi-zone L4 GPU quota-hunting
# VM creation script for the old manual "always-on fortress" pattern). Permanently disabled.
