...
# instructions/272: Tombstoned (legacy, unreferenced manual Cloud Run/Firebase deploy
# script superseded by .github/workflows/deploy_cloud_run.yml). Permanently disabled.
